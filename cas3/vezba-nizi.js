...
for (let index = 0; index < friend.length; index++) {
  ...
  console.log(`My friend: ${friend[index]} 20:42`)
}


// VEZBA-2
// Za dadena niza od elementi, da se ispecatat vo obraten redosled
...
// VEZBA-3
// Imame niza od dnevni temperaturi, da se najde prosecnata temp za dadenite denovi
...
// VEZBA-4
// Imame valkana niza koja sto sodrzi razlicni tipovi na elemnti, vklucuvajki i nedefinirani vrednosti
